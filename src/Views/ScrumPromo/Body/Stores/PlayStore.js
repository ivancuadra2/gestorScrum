...
export default function PlayStore() {
  return (
    <div
      onClick={() => alert(
        "App aún no subida a la store. La puede descargar clickeando el botón de comenzar a jugar al principio o al final de la web."
      )}
    >
      <span className="icon">
        <svg
        ...
        >
          <g fill="none" fillRule="evenodd">
            ...
            ></path>
            <path
              d="M130 0H5C2.25 0 0 2.25 0 5v30c0 2.75 2.25 5 5 5h125c2.75 0 5-2.25 5-5V5c0-2.75-2.25-5-5-5m0 .8c2.316 0 4.2 1.884 4.2 4.2v30c0 2.316-1.884 4.2-4.2 4.2H5A4.205 4.205 0 01.8 35V5C.8 2.684 2.684.8 5 .8h125"
              fill="#A6A6A6"
            ></path>
            <path
              d="M47.419 10.243c0 .838-.248 1.505-.745 2.003-.566.592-1.3.888-2.205.888-.867 0-1.602-.3-2.208-.9-.607-.6-.909-1.346-.909-2.234 0-.889.303-1.633.91-2.234.605-.6 1.34-.9 2.207-.9.43 0 .841.083 1.231.251.392.168.704.391.94.67l-.529.528c-.396-.474-.944-.712-1.642-.712-.632 0-1.178.222-1.639.666-.46.445-.69 1.021-.69 1.731 0 .71.23 1.286.69 1.73a2.278 2.278 0 001.64.666c.67 0 1.227-.223 1.675-.67.29-.29.457-.695.502-1.215H44.47v-.72h2.907c.029.156.043.307.043.452"
              fill="#FFF"
            ></path>
            <path
              d="M47.419 10.243c0 .838-.248 1.505-.745 2.003-.566.592-1.3.888-2.205.888-.867 0-1.602-.3-2.208-.9-.607-.6-.909-1.346-.909-2.234 0-.889.303-1.633.91-2.234.605-.6 1.34-.9 2.207-.9.43 0 .841.083 1.231.251.392.168.704.391.94.67l-.529.528c-.396-.474-.944-.712-1.642-.712-.632 0-1.178.222-1.639.666-.46.445-.69 1.021-.69 1.731 0 .71.23 1.286.69 1.73a2.278 2.278 0 001.64.666c.67 0 1.227-.223 1.675-.67.29-.29.457-.695.502-1.215H44.47v-.72h2.907c.029.156.043.307.043.452h0z"
              stroke="#FFF"
              strokeWidth=".2"
            ></path>
            <path
            ...
            ></path>
            <path
              d="M69.78 11.722a2.2 2.2 0 001.63.674 2.2 2.2 0 001.63-.674c.443-.45.666-1.024.666-1.722s-.223-1.273-.667-1.722a2.201 2.201 0 00-1.63-.675c-.643 0-1.186.225-1.63.675-.443.45-.666 1.024-.666 1.722s.223 1.272.666 1.722m3.83.502c-.59.607-1.323.91-2.2.91-.877 0-1.61-.303-2.199-.91-.59-.606-.884-1.347-.884-2.224 0-.877.294-1.619.884-2.225.59-.606 1.322-.91 2.2-.91.871 0 1.602.305 2.195.914.592.61.888 1.35.888 2.221 0 .877-.295 1.618-.884 2.224"
              fill="#FFF"
            ></path>
            <path
              d="M69.78 11.722a2.2 2.2 0 001.63.674 2.2 2.2 0 001.63-.674c.443-.45.666-1.024.666-1.722s-.223-1.273-.667-1.722a2.201 2.201 0 00-1.63-.675c-.643 0-1.186.225-1.63.675-.443.45-.666 1.024-.666 1.722s.223 1.272.666 1.722h0zm3.83.502c-.59.607-1.324.91-2.2.91-.878 0-1.61-.303-2.2-.91-.59-.606-.884-1.347-.884-2.224 0-.877.294-1.619.884-2.225.59-.606 1.322-.91 2.2-.91.871 0 1.602.305 2.195.914.592.61.888 1.35.888 2.221 0 .877-.295 1.618-.884 2.224h0z"
              stroke="#FFF"
              strokeWidth=".2"
            ></path>
            <path
            ...
            ></path>
            <g fill="#0EF076">
              <path d="M10.435 7.538l12.464 12.463 4.223-4.224-14.608-8.3c-.402-.229-.783-.337-1.121-.337a1.28 1.28 0 00-.958.398z"></path>
            </g>
            <g>
              <path
